...
function rechercherCandAction($id) {
    
    $em = $this->getDoctrine()->getManager();
    
    $valeur = $em->getRepository("RLSLAMBundle:Candidat")->listerCandidat($id);    
 
    return $this->render('RLSLAMBundle:Candidat:testRepo.html.twig',array('result'=>$valeur));
}
